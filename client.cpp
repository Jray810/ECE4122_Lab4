...
int main(int argc, char* argv[])
{
    ...
    unsigned short portNumber = stoi(portString, nullptr, 0);
    ...
    if (socket.connect(server, portNumber) != sf::Socket::Done)
    {
        cerr << "Unable to connect to desired IP Address and port number.";
        cerr << "\nPlease check your values and press ENTER key to end the program!\n";
        cin.ignore();
        return ERROR;
    }
